...
{
    ASSERT_EQ(m_object0->GetPosition(), vector3f_t(0, 0, 0));
    m_object0->SetPosition(vector3f_t(1, 2, 3));
    ASSERT_EQ(m_object0->GetPosition(), vector3f_t(1, 2, 3));
}

TEST_F(ObjectTest, Clone)
{
    m_object0->SetPosition(vector3f_t(2, 3, 4));
...
TEST_F(ObjectTest, AttachBidirectional)
{
    ...
    m_object0->SetPosition(vector3f_t(0, 0, 0));
    m_object1->SetPosition(vector3f_t(0, 0, 0));
    ...
    // Move object 1
    m_object1->SetPosition(vector3f_t(5, 6, 7));
    ASSERT_EQ(m_object1->GetPosition(), vector3f_t(5, 6, 7));
